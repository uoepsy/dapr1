...
author: "B007007"
date: "Block 3 (semester 2, week 3)"
...
**Week 3: Hypothesis testing using critical values**

Let $\mu$ denote the mean body temperature of all healthy humans. At the 5% significance level, we performed a one-sample t-test of $H_{0} : \mu = 37$ against $H_{1} : \mu \neq 37$. The sample data provided significant evidence to reject the null hypothesis in favour of the alternative one that the mean body temperature of healthy humans differs from the commonly thought value of 37 °C, $t(49) = -3.14, p < .05$, two-sided. Specifically, the observed t-statistic (-3.14) was smaller than the lower critical value (-2.01).



# Discussion

To be finished in the next weeks.
...
The sample data indicated that the population mean body temperature significantly differs from 37 °C and, specifically, that it may be lower than that value. The population mean is somewhere between 36.69 °C and 36.93 °C, with 95% confidence. 
