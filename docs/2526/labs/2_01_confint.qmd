...
Formative Report C covers the labs from weeks 1-5 of the DAPR1 course in semester 2. You’ll need to create a PDF report using RMarkdown, which will be submitted by 12 noon on Friday, 13th February 2026. No extensions are available as this is a formative report. Expect written formative feedback in Flexible Learning Week.
