...
GOFtest2$expected #check that our expected count is at least 5 in each category
...
TOI
TOI$expected #check that our expected count is at least 5 in each category
