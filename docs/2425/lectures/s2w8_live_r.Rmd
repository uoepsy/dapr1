...
#### PIVOT_LONGER DEMO #####
##T-TEST CAN BE ON WIDE OR LONG DATA - NOT NECESSARY TO DO THIS - JUST FOR SHOW ##
data_long <- rt_data2 %>%
  pivot_longer(c(VisualCue_AvgRT, AuditoryCue_AvgRT), names_to = "Cue_Condition", values_to = "AvgRT")
  
res3_long <- t.test(data_long$AvgRT ~ data_long$Cue_Condition,
               paired = TRUE,
               mu = 0,
               alternative = "two.sided")
res3_long
