...
We computed the probability of acceptance at both levels of GPA. The probability of acceptance given a high GPA was `r round(pTab['High', 'Accepted']/(sum(pTab['High',])), 2)`. The probability of acceptance given a low GPA was only `r round(pTab['Low', 'Accepted']/(sum(pTab['Low',])), 2)`. This indicates that the likelihood of being accepted changes at different levels of GPA.
