...
cmaterials <- cmaterials %>% transmute(
  ...
  Workbook = case_when(
    !is.na(workshop) & nchar(workshoplink)>0 ~ paste0('<a href="',workshoplink,'">',workshop,'</a>'),
    !is.na(workshop) ~ paste0('<span style="opacity:.6">',workshop,'</span>'),
    TRUE ~ ""
  )
)
...
course_descriptions = list(
  dapr1 = 'Data Analysis for Psychology in R 1 (DAPR1) is a course taken by 1st year students in Psychology. It introduces you to data collection, description, and visualisation using the R programming language. In semester 2, you will also learn how to use experimental data to test simple research hypotheses.',
