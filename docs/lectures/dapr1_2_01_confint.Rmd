...
```{r}
knitr::include_graphics('images/confint/normal_rule.png')
```
...
```{r}
knitr::include_graphics('images/confint/bias_prec.png')
```
...
```{r}
knitr::include_graphics('images/confint/2_01_sampl_dist.png')
```
...
```{r}
knitr::include_graphics('images/confint/2_01_sampl_dist_t.png')
```
...
```{r}
knitr::include_graphics('images/confint/2_01_sampl_dist_t_2.png')
```
...
```{r}
knitr::include_graphics('images/confint/2_01_one_sample.png')
```
...
```{r}
#| out.width = "50%"
knitr::include_graphics('images/confint/int-ci-1.png')
```
...
```{r}
#| out.width = "50%"
knitr::include_graphics('images/confint/int-ci-2.png')
```
