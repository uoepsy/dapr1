...
TODO flashcard variability/IQR?  
...
TODO flashcard variability/range?
...
`r qbegin(qcounter())`
In one call to `summarise()`, calculate relevant descriptive statistics for all three variables `sleepqual`, `procrast` and `multitask`.  

::: {.callout-tip collapse="true"}
#### Hints

TODO flashcard summarise()? or somewhere that shows you can compute multiple summary stats in one call?  
