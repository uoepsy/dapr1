...
```{r results="asis",echo=FALSE, out.width="20%",fig.cap="click to zoom in/out"}
...
- Click to expand the "Quick Links" folder
- Click on "Group Discussion Space"

```{r results="asis",echo=FALSE, out.width="20%",fig.cap="click to zoom in/out"}
knitr::include_graphics("images/serverfiles/groupspace.jpeg")
```
...
```{r results="asis",echo=FALSE, out.width="20%",fig.cap="click to zoom in/out"}
knitr::include_graphics("images/serverfiles/post.jpeg")
```
...
$(document).ready(function() {
  ...
  // Open zoom when clicking any thumbnail/image
  $('img:not(.zoomImg)').click(function(e) {
    e.stopPropagation(); // Prevents document click from firing immediately
    $('.zoomImg').attr('src', $(this).attr('src'));
    $('.zoomDiv').css({opacity: '1', width: '60%'});
  });

  // Close zoom when clicking anywhere on the document or overlay
  $(document).add('.zoomDiv').click(function() {
