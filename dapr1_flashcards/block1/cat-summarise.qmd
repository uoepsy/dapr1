---
title: "Summarise categorical data"
---
...
<br><br>
+ `|>` (pipe) takes the output of whatever is on the LHS and gives it as the input of whatever is on the RHS.
+ `count()` counts the number of occurrences of each unique value in a variable.
+ `mutate()` adds variables to the dataframe, or modifies existing variables. 
