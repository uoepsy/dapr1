...
+ Raw deviation is the distance between each person's age and the mean age. 
]
...
+ Let's compute the correlation between the number of days in the program and the max running distance for our entire sample of 500:
