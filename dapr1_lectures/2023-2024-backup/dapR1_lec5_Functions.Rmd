...
+ Quiz on continuous data
  + Open Monday 09:00
  + Closes Sunday 17:00
  + Feedback available after due date

+ Week 6
  + No lectures on Monday and Tuesday 
  + Labs will still take place
  + In the labs
    + check the feedback given for your formative report
    + study the example solutions and ask questions if anything is unclear
