...
1. Explain Type I and Type II errors in hypothesis testing and recognise how the significance level and power relate to these errors.

1. Describe the factors affecting statistical power and distinguish between statistical significance and practical significance using effect size.

1. Check the assumptions underlying the one-sample t-test.
...
- Hypothesis tests (i.e. tests of significance) let us decide between competing hypotheses. 

- However, statistical significance sometimes may lead us to incorrect decisions!

- It is possible to make two kinds of incorrect decisions:

  - rejecting a true null hypothesis 

  - not rejecting a false null hypothesis

- After performing a hypothesis test, whether your decision is either to (a) reject $H_0$ or (b) not reject $H_0$, you might be making an error.

- We will discuss common pitfalls of hypothesis testing, as well as the factors that influence the probability of committing these errors.
...
- Table above shows the possible outcomes of testing $H_0 : \text{Defendant = Not guilty}$
...
The possibilities in such a trial are given in this table.
...
- Like convicting an innocent person, the error of rejecting a true null hypothesis is considered more serious.
...
- i.e., you could reject $H_0$ when it is true
]
...
- i.e., you could fail to reject $H_0$ when it is false
]
...
- Table above shows the possible outcomes of testing $H_0 : \mu = \mu_0$
...
- If you decrease $\alpha$ to make it harder to reject $H_0$, we would reduce the probability of making a Type I error. However, we would make Type II errors more often. 

- Choosing a larger $\alpha$ to make it easier to reject $H_0$ would reduce the chance of making a Type II error. However, this increases the chance of making a Type I error and we would end up rejecting too many $H_0$'s that were actually true. 
...
- Attend your lab and work together on the lab tasks
    ...
    - Submit Formative Report C by 12 noon on Friday the 13th of February 2026
