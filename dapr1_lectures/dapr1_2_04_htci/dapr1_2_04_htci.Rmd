...
text(xbar, 0.10, label = expression(bar(x) == 47), col = 'black', 
     cex = 1.1, adj = 1.18)
text(xbar, 0.07, label = expression(t == -2.99), col = 'blue', 
     cex = 1.1, adj = 1.1)
...
- Read the lab worked example and complete your lab
    ...
    + Remember you need to submit Formative Report C by 12 noon on Friday the 16th of February 2024 (next week).
