...
> At the 5% significance level, the sample data provide very strong evidence to reject the null hypothesis in favour of the alternative one that the mean body temperature of healthy humans is different from the long thought 37 °C; $t(49) = -3.14, p = .003$, two-sided.
