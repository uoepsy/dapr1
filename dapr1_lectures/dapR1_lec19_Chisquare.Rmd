...
subtitle: "<small>Data Analysis for Psychology in R 1<br>Semester 2 Week 9</small>"
...
- Understand the difference between $\chi^2$ goodness-of-fit and $\chi^2$ test of independence
- Understand how to perform a $\chi^2$ goodness-of-fit and interpret results
- Understand how to perform a $\chi^2$ test of independence and interpret results
...
+ Need to calculate separately for each level
  
+ *Example of number of flowers sold on a Monday:* $\quad \frac{54-53.86}{\sqrt{53.86}} \quad = \quad 0.019$
...
+ You need to calculate separately by cell

+ *Example of number of Lilies sold in Spring*
    + $\frac{O_{ij}-E_{ij}}{\sqrt{E_{ij}}} \quad = \quad \frac{186-182.08}{\sqrt{182.08}} \quad = \quad 0.291$
...
+ Cramer's $V$ must lie between 0 and 1 
    + 0 = complete independence, 1 = complete dependence 
...
$V \quad = \quad \sqrt{\frac{\chi^2}{n\cdot\ df^*}} \quad = \quad \sqrt{\frac{2.40}{2348\cdot\ 2}} \quad = \quad 0.023$
...
Calculate via `cramers_v()` function from **`effectsize`** package in `R` - do not calculate by hand
