...
+ The probability that we would have a $\chi^2$ value as extreme as `r round(sum(divTab[flowerCols]), 2)` if $H_0$ is true is `r round(pchisq(sum(divTab[flowerCols]),df = 6,lower.tail = F), 3)`.
