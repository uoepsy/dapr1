...
> **RQ:** How does an additional day of interrupted sleep affect cognitive skills?  <br><br>
...
sleepwordle |> 
  ...
  geom_point(size=3,alpha=.3,col="tomato1")+
  stat_smooth(method=lm,se=FALSE,color="blue",lwd=2)+
  geom_segment(x=5,xend=5,y=sleepwordle$wordle[52],
               yend = (coef(fitw) %*% c(1,5))[1],
               lty = "dotted", col="black", lwd=1) +
  geom_point(x = 5, y = sleepwordle$wordle[52],
             size = 3,col="tomato1") +
...
we're basing these predictions on groups of _different_ people. i.e., to answer our question we're comparing: 
  person_A with 4 days sleep dep 
  vs 
  personB with 5 days sleep dep
...
read as `outcome "is predicted by" predictor`
