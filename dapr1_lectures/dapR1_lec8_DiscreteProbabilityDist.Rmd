...
+ Recall our definition of a **random experiment:** 
    + It could (theoretically) be infinitely repeated
...
+ **Simple Experiment:** Rolling 2 6-sided dice

> **Test your understanding:** What might we use for our random variable?
