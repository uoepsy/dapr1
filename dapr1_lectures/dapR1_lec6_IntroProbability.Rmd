...
- Deterministic models imply certainty, consistency, and a complete knowlege of all relevant infomration

- But real world data (especially human particiants!) are have a lot going on
...
.pull-right[
<span style="color: #00339B; font-weight:bold"> U = Universal Set </span>: All possible elements in a category of interest (i.e., the possible outcomes in a situation you're interested in)
...
$A^c$ = Complement of A
  - $A^c$ = { $x$ | $x \in U, x \notin A$}
  - $A^c$ = $U$ - $A$
  - NOTE: complement is equivalent to 'not' operator, or $\neg A$ ( or $!A$ in R) 
