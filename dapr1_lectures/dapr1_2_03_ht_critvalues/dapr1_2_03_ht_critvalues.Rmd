...
- As the p-value is `r signif(pvalue, 2)`, which is less than the chosen significance level, we reject the null hypothesis.
...
- In this case, $t =$ `r round(tobs, 2)` is larger than the critical value $\geq t^* =$ `r round(qt(0.975, n-1), 2)`.
]
