...
plt.t <- ggplot(tibble(t = tscores.sampl.dist)) + 
    ...
    stat_function(aes(x = t), fun = \(x) dt(x, df = n-1), alpha = 0.75,
                  color = 'blue', size = 1, n = 501, linetype = 2) +
    labs(x = 't-statistic', y = 'Density',
         caption = 'Red solid line: Standard Normal\nBlue dashed line: t(n-1)') +
...
ggplot(plt, aes(x, y)) +
    ...
    geom_vline(xintercept = tobs, color = 'darkgreen', size = 1, linetype = 2) +
