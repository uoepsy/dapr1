...
# Step 4. Make a decision by comparing the observe t-statistic to the 
...
The sample data provided very strong evidence that the mean body temperature of all healthy humans is different from 37 °C. Furthermore, we are 95% confident that the true mean value is between 36.69 °C and 36.93 °C, i.e. between 0.07 and 0.31 lower than the commonly thought value of 37 °C.
