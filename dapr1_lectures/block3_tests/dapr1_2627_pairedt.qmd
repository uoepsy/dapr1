...
What do we conclude about normality based on skew and plots?
 
ANSWER:

- Skew is low (< 1), so we would conclude that it is not problematic
- Histogram and density plot looks fairly normally distributed 
- QQPlot: we want our points to be as close to this line as possible, and there doesn't appear to be much deviation
...
##  Shapiro-Wilks Test Interpretation TO DO!! 
