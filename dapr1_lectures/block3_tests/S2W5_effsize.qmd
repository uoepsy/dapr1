...
- But an effect can be absolutely tiny and still be statistically significant
- For an effect to be practically significant, it should have a reasonable effect size
:::


:::{.dapr1callout}
How do we know what kind of effect is "small", "medium", or "large" for each test we've seen this Block?

- We convert our test result into the appropriate standardised measure of effect size
  ...
  - For Pearson or Spearman's correlations: the correlation coefficent
:::
...
# How can we measure practical significance?
...
## For the ADHD/ASD co-occurrence data: $\phi$ 
...
## For sexuality/attachment style: Cramér's $v$
