...
- Summarise the relationship with either a table or a number, depending on the type of the variables.[^s1w4-cov-na]
...
- Summarise with table how the relationship above varies across the third variable.^[
