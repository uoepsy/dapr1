...
- Summarise the relationship with either a frequency table or descriptive statistics, depending on the type of the variables.[^s1w4-cov-na]
...
```{r echo = FALSE}
kable(list(mon, tue, wed, thu, fri),
      caption = "Frequency tables of Credit by Server for each day of the week (Mon to Fri)") %>%
    kable_styling()
```
