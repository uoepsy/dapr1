...
- Organise your report to have three sections:
    ...
    + Introduction, where you write a short introduction to the data for a generic reader
    + Analysis, where you will present all your tables and plots
    + Discussion, where you will write some take-home messages about the data and the insights you learned
