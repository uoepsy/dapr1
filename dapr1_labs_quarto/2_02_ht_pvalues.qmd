...
__This week you will only focus on task C2.__
...
- Using a 5% significance level, i.e. $\alpha = 0.05$ make a decision on whether or not to reject the null hypothesis.^[Hint: compare the p-value with the significance level.  
