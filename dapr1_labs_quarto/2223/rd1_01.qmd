...
**Recommended option**: access it via the RStudio server. Try these steps first to register for RStudio server online:
...
knitr::include_graphics("images/rstudio_intro/rmarkdown_wizards.png")
```
...
![](images/rstudio_intro/compiling.png)
...
![](images/rstudio_intro/ss_newrmd.png)
...
![](images/rstudio_intro/runchunk.png)
:::
...
![](images/rstudio_intro/headings.png)
...
![](images/rstudio_intro/ss_examples.png)
