...
- As each movie was rated by a different pool of 50 audience raters, discuss how this new `IQ` column can be considered an independent sample of IQ scores.

- Plot the sample distribution of the `IQ` variable either using a histogram or density plot.[^plot-freq]
