...
- Compute the value of the t-statistic from the sample mean graduation rate of female students.

- Identify the null distribution.

- Compute the critical values of the null distribution using the appropriate significance level.
