...
- Register for your group on LEARN:  
go to the course LEARN page > click Groups > click Labs_1_2_3, find your group and click Join.
- [Download the template Rmd file and write your work in this file](https://uoepsy.github.io/dapr1/2425/useful_files/template_formative_report_b.Rmd). Remember to save your work often.
    - Ensure your report title includes the group name: Group NAME.LETTER
    - In the author section, ensure the report lists the exam numbers of all group members.
- Formative Report B spans the labs of the second block of DAPR1 teaching (weeks 7-11).
    - Report due date: 12 noon on Friday the 29th November 2024.
...
In weeks 7-11 of the course your group should produce a PDF report (using Rmarkdown) for which you will receive written formative feedback in week 12.
