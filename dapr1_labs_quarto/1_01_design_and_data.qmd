...
::: {.column-margin}
As a reminder, the course includes four teaching blocks (Blocks 1--4). Each block spans five weeks of teaching. For more information see the "Course information" page on Learn.
:::
...
- The reports are due:
    + Formative Report A (Block 1): 12 noon, Friday 20th February 2023.
    + Formative Report B (Block 2): 12 noon, Friday 1st December 2023.
    + Formative Report C (Block 3): 12 noon, Friday 16th January 2024.
...
- In each group, one person is the *driver* and the rest are the *navigators* and cannot type on the PC. 
    + The driver is responsible for typing on the PC keyboard.  
...
- Driver: download the template Rmd file, and start writing your work there. Don't forget to save your file regularly via File -> Save. 
...
Complete it in the following weeks, and follow instructions in week 5 on how to "knit" to submit a PDF file. This will be taught in the next weeks.
:::
...
In order to generate a PDF file from RStudio, you must have a packaged called `tinytex` installed. This allows you to "Knit" your Rmd document (i.e. combine together text, code, and output) to produce a PDF file:
...
- [Successful knitting checklist](https://uoepsy.github.io/dapr1/checklist_knitting.Rmd)
...
tips <- read_csv("../../data/RestaurantTips.csv")
head(tips)
```
