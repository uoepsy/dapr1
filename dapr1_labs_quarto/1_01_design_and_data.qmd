...
- Read the movie data into R, and give it a useful name. Inspect the data by looking at the data in RStudio. You don't need to show the data in the report, a description in words is sufficient.^[
Hint: `View(DATA)` <br>
or `head(DATA)`
]
