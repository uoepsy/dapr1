...
[Click here to download the template Rmd file](https://uoepsy.github.io/dapr1/2324/useful_files/template_formative_report_a.Rmd)
...
__Curiosity:__ Sometimes you may also find an older version of the pipe, which is `%>%` and works in the same style. However, it requires the package tidyverse to be loaded before you can use the older pipe `%>%`.
:::
