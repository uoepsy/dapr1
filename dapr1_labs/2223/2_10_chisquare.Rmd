...
:::yellow
Note that the formula has the same look as the $\chi^2$ goodness-of-fit test, but the difference lies in the _degrees of freedom_ and how the expected counts are computed.
:::
