...
> C2) At the 5% significance level and using the p-value method, test whether the 2012 mean graduation rate for female students at colleges and universities in the United States is significantly different from a rate of 50 percent.  
...
- Specify the null and alternative hypotheses for the research question specified in Task C2.[^hypotheses]
