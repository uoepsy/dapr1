...
`r optbegin("Option A: The RStudio PPLS Server (click to expand)", olabel=FALSE)`
...
`r optbegin("Option B: Installing R and RStudio locally (click to expand)",olabel=FALSE)`
:::red
