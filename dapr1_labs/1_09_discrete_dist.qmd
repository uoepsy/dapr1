...
| `geom_point() ` | Adds points to a plot. Used for scatter plots as well as for adding specific values/markers to existing plots (ggplot2) |
| `geom_segment() ` | Adds line segments to a plot by specifying start and end coordinates (ggplot2) |
