...
Be sure to check the [**solutions to last week's exercises**](1_02_categorical.html).<br>You can still ask any questions about previous weeks' materials if things aren't clear!
...
`r optbegin("Optional - Help reading mathematical formulae. Click to expand", olabel=FALSE)`
...
`r optbegin("Optional: Why n minus 1? Click to expand", olabel=FALSE)`
