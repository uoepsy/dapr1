...
Let $\mu$ denote the mean weight (in kg) of _all_ dogs in Seattle.
...
`r qbegin(8)`
Read in the data (a .csv is at [https://uoepsy.github.io/data/pass_scores.csv](https://uoepsy.github.io/data/pass_scores.csv)), produce some descriptive statistics, and conduct a one sample mean test to evaluate whether Edinburgh University students' average score on the PASS is less than 33.  
