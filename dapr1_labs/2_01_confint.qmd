...
[Download the template Rmd file and start your work there](https://uoepsy.github.io/dapr1/2526/useful_files/template_formative_report_c.Rmd). Save your work regularly by clicking File > Save.

::: {.callout-important collapse="true"}
### Instructions - Don't Skip! {-}

Formative Report C covers the labs from weeks 1-5 of the DAPR1 course in semester 2. You’ll need to create a PDF report using RMarkdown, which will be submitted by 12 noon on Friday, 13th February 2026. No extensions are available as this is a formative report. Expect written formative feedback and solutions in Flexible Learning Week.
...
Don't forget to register for your lab table group on LEARN by navigating to the course LEARN page, clicking on **Groups**, selecting **Sem 2 - Labs_1_2_3_4**, finding your group, and clicking **Join**.
...
cb <- tibble(
    ...
    Description = 
        c("College Type: <br><i>
          ...
          8 = Far West; <br>
          9 = Outlying areas</i>", 
          "Graduation Rate (Percentage) – All <br><i>NA = missing</i>", 
          "Graduation Rate (Percentage) – Men <br><i>NA = missing</i>", 
          "Graduation Rate (Percentage) – Women <br><i>NA = missing</i>")
)
...
> C1) Read the data into R, describe the variable of interest both visually and numerically, and provide an estimate and 95% CI for the mean graduation rate of female students at US colleges and universities in 2012.
