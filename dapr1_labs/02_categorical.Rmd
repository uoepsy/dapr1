...
`r optbegin("IMPORTANT READING: A different style of R code. Click the plus to expand &#8594;", olabel=FALSE)`
...
`r optbegin("Extra detail on how this works. Click the plus to expand &#8594;", olabel=FALSE)`
...
`r optbegin("Optional - Different aes() and geoms, and labels. Click the plus to expand &#8594;", olabel=FALSE)`
...
```
`r optbegin("Optional extra. Click the plus to expand &#8594;", olabel=FALSE)`
