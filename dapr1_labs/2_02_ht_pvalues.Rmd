...
`r optbegin("Visualise the t-statistics", olabel = FALSE)`
We can use the previous histogram of sample means (null distribution) and, instead of plotting the actual means, we can plot the t-score of each mean:
