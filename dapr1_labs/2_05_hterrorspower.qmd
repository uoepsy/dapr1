...
- Your group must submit one PDF file for formative report C by 12 noon on Friday 13th of February 2026.
...
- In Flexible Learning Week (FLW), i.e. next week:
    ...
    + At the end of FLW, we will send an announcement when we will have finished providing feedback on your submissions. Please review your feedback when we announce it is ready.
...
- Submit the PDF file on Learn by 12 noon on Friday 13th of February 2026:
    + Go to the Learn page of the course
    + Click Assessments
    + Click Submit Formative Report C (PDF file only)
