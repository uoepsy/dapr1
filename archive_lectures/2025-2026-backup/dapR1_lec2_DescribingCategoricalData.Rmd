...
+ For ordinal data:
  + The first, or lower quartile is the first category for which the cumulative percentage is $\geq 25\%$.  
  + The median is the first category for which the cumulative percentage is $\geq 50\%$.  
  + The third, or upper quartile is the first category for which the cumulative percentage is $\geq 75\%$.
...
- Complete the second practice quiz
    + Opens Monday at 9am
