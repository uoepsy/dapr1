...
.pull-left[
+ Let's imagine we have data on the handedness of children who like and dislike comic books in a classroom

+ Just by looking at our data, the likelihood of being left-handed changes depending on whether the student likes or dislikes comic books

+ Specifically, if a student is right-handed, they are more likely to be like comics than if they are left-handed
...
+ **If we select one comic liker from the class, what is the probability that they are left handed?**
...
$$P(Left | Like) = \frac{P(Left \bigcap Like)}{P(Like)}$$
...
$$P(Left|Like) = \frac{\frac{10}{100}}{\frac{51}{100}}$$
$$P(Left|Like) = \frac{0.10}{0.51} = .196$$
]
...
>  + $P(Left|Like) = \frac{.10}{.51} = .196$
  
>  + $P(Like|Left) = \frac{.10}{.35} = .286$
...
$$P(Left|Like) = \frac{P(Like|Left)}{P(Like)}P(Left)$$
...
$$P(Like|Left) = \frac{10}{35} = .2857$$
$$P(Left|Like) = \frac{0.2857}{.51}\times.35 = .196$$
