...
- **Estimation**. Last week we learned how to:
...
- **Hypothesis testing**. What if instead we had a specific hypothesis/theory we wanted to test?
...
--
    ...
    - The null hypothesis $H_0$ is usually the hypothesis that is assumed to be true to begin with.
        
        + It typically corresponds to "no change", "no effect", "no difference", "no relationship". 
...
- The prosecutor is trying to provide evidence that the person is guilty

--

    - The alternative hypothesis is the claim that we wish to find evidence for.
    
        + It is typically the hypothesis that embodies the research question of interest.
