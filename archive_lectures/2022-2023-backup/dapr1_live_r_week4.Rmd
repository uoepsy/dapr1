...
Of course, in real life, the relationships between variables are not as neat as the simlistic example above. Let's have a look at the relationship between "Score1" and "Score2" in the ex1 dataset. 
