...
| `geom_histogram() `     | Creates histogram plots showing the distribution of numeric data divided into bins (tidyverse) |
| `geom_density() `     | Creates smooth density curves showing the distribution shape of numeric variables (tidyverse) |
| `geom_line() `     | Adds lines to a plot by connecting points (tidyverse) |
| `after_stat()`      | Accesses transformed variables calculated during plotting (e.g., density for histograms) (tidyverse) |
